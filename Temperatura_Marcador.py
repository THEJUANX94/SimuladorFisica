...
class TemperaturaMarcador:
    def __init__(self, x, y, font_size=24):
        ...
        self.text_color = (26, 35, 46)  # Azul oscuro
    ...
    def draw(self, screen):
        if self.temperatura is not None:
            ...
            temperaturaF_text = self.font.render(f"Temp. °F: {round(self.temperatura * (9 / 5) + 32)}°", True,
                                                 self.text_color)
            ...
            text_rectF = temperaturaF_text.get_rect()
            ...
            text_rectK = temperaturaK_text.get_rect()
